        ...
        uploadZipFile({ FileData: file })
          .then(data => {
            ...
            /*   console.log('objwithoutExternalId      ');
               console.log(objwithoutExternalId);
               console.log(this.objwithoutExternalId.length);*/
             ...
             /* console.log(data[key].ExternalIdField);
              console.log(key);*/
              console.log('bothInsertUpsert before', this.bothInsertUpsert);
            
            if (this.objectsWithoutExternalId.length > 0 && this.objectsWithExternalId.length > 0) {
              this.bothInsertUpsert = true;
              console.log('bothInsertUpsert after', this.bothInsertUpsert);
            }
         /*   else {
              this.bothInsertUpsert = false;
            }*/
          })
          .catch(error => {
